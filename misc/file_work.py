...
class FileWork:
    def __init__(self, file_name=""):
        ...
        self.data = {"baudrate": 3, "num_of_bits": 4, "parity": 0, "stop_bits": 0, "start_address": 1,
    ...
    def saveConfig(self):
        ...
        self.data["baudrate"] = con_panel_config[0]
        self.data["num_of_bits"] = con_panel_config[1]
        self.data["parity"] = con_panel_config[2]
        self.data["stop_bits"] = con_panel_config[3]
